...
class _QRScannerPageState extends State<QRScannerPage> {
  ...
  void _onDetect(BarcodeCapture capture) async {
    ...
    try {
      ...
      // Uses verifyQrCodeFunction which now uses school.token
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            SizedBox(height: 1.h),
            Text(
              'L\'ordine è stato segnato come consegnato.',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Scansiona QR Studente'),
        backgroundColor: mainColor,
          ...
          Positioned(
            ...
            child: Center(
              child: Container(
                ...
                child: const Text(
                  'Inquadra il QR code dello studente',
